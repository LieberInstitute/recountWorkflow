...
```{r Figure3, out.width="100%", fig.align="center", fig.cap = "RNA-seq starting data. 16 RNA-seq un-aligned RNA-seq reads 3 base-pairs long are shown (pink boxes) alongside a reference genome that is 16 base-pairs long (white box).", echo = FALSE}
knitr::include_graphics("Figure3.png")
```

Reads in the recount2 resource were aligned with the splice-aware Rail-RNA aligner [@rail-rna]. Figure \@ref(fig:Figure4) shows the reads aligned to the reference genome. Some of the reads are split as they span an exon-exon junction. Two of the reads were soft clipped meaning that just a portion of the reads aligned (top left in purple). 
...
```{r "limmade1", out.width="100%", fig.align="center", fig.cap = "Multi-dimensional scaling plot of the gene-level data by age group."}
library("limma")
library("edgeR")
...
```{r "limmade2", out.width="100%", fig.align="center", fig.cap = "Multi-dimensional scaling plot of the gene-level data by sex."}
...
```{r "limmade3", out.width="100%", fig.align="center", fig.cap = "voom mean-variance plot of the gene-level data."}
## Run voom
...
```{r "limmaplots1", out.width="100%", fig.align="center", fig.cap = "MA plot of the gene-level data. Testing for prenatal and postnatal DE adjusting for sex and RIN."}
## Visually explore DE results
limma::plotMA(fit, coef = 4)
```

```{r "limmaplots2", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the gene-level data. Testing for prenatal and postnatal DE adjusting for sex and RIN."}
...
```{r "goanalysis", out.width="100%", fig.align="center", fig.cap = "Biological processes enriched in the DE genes."}
library("clusterProfiler")
library("org.Hs.eg.db")
...
```{r "exondeanalysis1", out.width="100%", fig.align="center", fig.cap = "voom mean-variance plot of the exon-level data."}
## Download the data if it is not there
...
```{r "exondeanalysis2", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the exon-level data. Testing for prenatal and postnatal DE adjusting for sex and RIN."}
## Run remaining parts of the DE analysis
...
```{r "geneexon", out.width="100%", fig.align="center", fig.cap = "Venn diagram of the overlap between DE genes and genes with at least one exon DE."}
...
```{r "erdeanalysis1", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = "Multi-dimensional scaling plot of the expressed regions level data by age group."}
## Build DGEList object
...
```{r "erdeanalysis2", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = "Multi-dimensional scaling plot of the expressed regions level data by sex."}
plotMDS(dge_er, labels = substr(colData(rse_er_scaled)$sex, 1, 1) )
```

```{r "erdeanalysis3", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = "voom mean-variance plot of the expressed regions level data."}
## Run voom
...
```{r "erdeanalysis4", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the expressed regions level data. Testing for prenatal and postnatal DE adjusting for sex and RIN."}
...
```{r "regionplots", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = paste0("Base-pair resolution plot of differentially expressed region ", 1, ".")}
library("derfinderPlot")
