...
```{r "limmaplots1", out.width="100%", fig.align="center", fig.cap = "MA plot of the gene level data. Testing for prenatal and postnal DE adjusting for sex and RIN."}
## Visually explore DE results
limma::plotMA(fit, coef = 4)
```

```{r "limmaplots2", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the gene level data. Testing for prenatal and postnal DE adjusting for sex and RIN."}
...
```{r "exondeanalysis2", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the exon level data. Testing for prenatal and postnal DE adjusting for sex and RIN."}
## Run remaining parts of the DE analysis
...
```{r "erdeanalysis4", eval = .Platform$OS.type != "windows", out.width="100%", fig.align="center", fig.cap = "Volcano plot of the expressed regions level data. Testing for prenatal and postnal DE adjusting for sex and RIN."}
