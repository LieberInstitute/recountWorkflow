...
In these plots we can see that some DERs are longer than known exons (Figures \@ref(fig:regionplots1), \@ref(fig:regionplots2)), others match known exons (Figuress \@ref(fig:regionplots4), \@ref(fig:regionplots5), \@ref(fig:regionplots6), \@ref(fig:regionplots7), \@ref(fig:regionplots8)), and some are either un-annotated exons or reflect a coverage dip (Figures \@ref(fig:regionplots3), \@ref(fig:regionplots9), \@ref(fig:regionplots10)).
