...
This workflow was created using `BiocWorkflowTools` [@biocWorkflow]. The session information is available in Supplementary File 2. The published version of this workflow [@recountWorkflow] is available via F1000Research at TODO-INSERT-URL.
